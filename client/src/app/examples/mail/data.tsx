export const mails = [
  {
    ...
    html: "<p>Hi, let's have a meeting tomorrow to discuss the project. I've been reviewing the project details and have some ideas I'd like to share. It's crucial that we align on our next steps to ensure the project's success.</p><p>Please come prepared with any questions or insights you may have. Looking forward to our meeting!</p><p>Best regards, William</p>",
  ...
  },
  {
    ...
    html: "<p>Thank you for the project update. It looks great! I've gone through the report, and the progress is impressive. The team has done a fantastic job, and I appreciate the hard work everyone has put in.</p><p>I have a few minor suggestions that I'll include in the attached document.</p><p>Let's discuss these during our next meeting. Keep up the excellent work!</p><p>Best regards, Alice</p>",
  ...
  },
  {
    ...
    html: "<p>Any plans for the weekend? I was thinking of going hiking in the nearby mountains. It's been a while since we had some outdoor fun.</p><p>If you're interested, let me know, and we can plan the details. It'll be a great way to unwind and enjoy nature.</p><p>Looking forward to your response!</p><p>Best, Bob</p>",
  ...
  },
  {
    ...
    html: "<p>I have a question about the budget for the upcoming project. It seems like there's a discrepancy in the allocation of resources.</p><p>I've reviewed the budget report and identified a few areas where we might be able to optimize our spending without compromising the project's quality.</p><p>I've attached a detailed analysis for your reference. Let's discuss this further in our next meeting.</p><p>Thanks, Emily</p>",
  ...
  },
  {
    ...
    html: "<p>I have an important announcement to make during our team meeting. It pertains to a strategic shift in our approach to the upcoming product launch. We've received valuable feedback from our beta testers, and I believe it's time to make some adjustments to better meet our customers' needs.</p><p>This change is crucial to our success, and I look forward to discussing it with the team. Please be prepared to share your insights during the meeting.</p><p>Regards, Michael</p>",
  ...
  },
  {
    ...
    html: "<p>Thank you for your feedback on the proposal. It looks great! I'm pleased to hear that you found it promising. The team worked diligently to address all the key points you raised, and I believe we now have a strong foundation for the project.</p><p>I've attached the revised proposal for your review.</p><p>Please let me know if you have any further comments or suggestions. Looking forward to your response.</p><p>Best regards, Sarah</p>",
    read: true,
    labels: ["work"],
  },
  {
    ...
    html: "<p>I have an exciting new project idea to discuss with you. It involves expanding our services to target a niche market that has shown considerable growth in recent months.</p><p>I've prepared a detailed proposal outlining the potential benefits and the strategy for execution.</p><p>This project has the potential to significantly impact our business positively. Let's set up a meeting to dive into the details and determine if it aligns with our current goals.</p><p>Best regards, David</p>",
  ...
  },
  {
    ...
    html: "<p>Let's plan our vacation for next month. What do you think? I've been thinking of visiting a tropical paradise, and I've put together some destination options.</p><p>I believe it's time for us to unwind and recharge. Please take a look at the options and let me know your preferences.</p><p>We can start making arrangements to ensure a smooth and enjoyable trip.</p><p>Excited to hear your thoughts! Olivia</p>",
  ...
  },
  {
    ...
    html: "<p>I've completed the registration for the conference next month. The event promises to be a great networking opportunity, and I'm looking forward to attending the various sessions and connecting with industry experts.</p><p>I've also attached the conference schedule for your reference.</p><p>If there are any specific topics or sessions you'd like me to explore, please let me know. It's an exciting event, and I'll make the most of it.</p><p>Best regards, James</p>",
  ...
  },
  {
    ...
    html: "<p>Let's have a team dinner next week to celebrate our success. We've achieved some significant milestones, and it's time to acknowledge our hard work and dedication.</p><p>I've made reservations at a lovely restaurant, and I'm sure it'll be an enjoyable evening.</p><p>Please confirm your availability and any dietary preferences. Looking forward to a fun and memorable dinner with the team!</p><p>Best, Sophia</p>",
  ...
  },
  {
    ...
    html: "<p>I'd like your feedback on the latest project deliverables. We've made significant progress, and I value your input to ensure we're on the right track.</p><p>I've attached the deliverables for your review, and I'm particularly interested in any areas where you think we can further enhance the quality or efficiency.</p><p>Your feedback is invaluable, and I appreciate your time and expertise. Let's work together to make this project a success.</p><p>Regards, Daniel</p>",
  ...
  },
  {
    ...
    html: "<p>Here's the agenda for our meeting next week. I've included all the topics we need to cover, as well as time allocations for each.</p><p>If you have any additional items to discuss or any specific points to address, please let me know, and we can integrate them into the agenda.</p><p>It's essential that our meeting is productive and addresses all relevant matters.</p><p>Looking forward to our meeting! Ava</p>",
  ...
  },
  {
    ...
    html: "<p>The product launch is on track. I'll provide an update during our call. We've made substantial progress in the development and marketing of our new product.</p><p>I'm excited to share the latest updates with you during our upcoming call. It's crucial that we coordinate our efforts to ensure a successful launch. Please come prepared with any questions or insights you may have.</p><p>Let's make this product launch a resounding success!</p><p>Best regards, William</p>",
  ...
  },
  {
    ...
    html: "<p>Let's plan a team-building event for our department. Team cohesion and morale are vital to our success, and I believe a well-organized team-building event can be incredibly beneficial. I've done some research and have a few ideas for fun and engaging activities.</p><p>Please let me know your thoughts and availability. We want this event to be both enjoyable and productive.</p><p>Together, we'll strengthen our team and boost our performance.</p><p>Regards, Ethan</p>",
  ...
  },
  {
    ...
    html: "<p>The budget has been approved. We can proceed with the project. I'm delighted to inform you that our budget proposal has received the green light from the finance department. This is a significant milestone, and it means we can move forward with the project as planned.</p><p>I've attached the finalized budget for your reference. Let's ensure that we stay on track and deliver the project on time and within budget.</p><p>It's an exciting time for us! Chloe</p>",
  ...
  },
  {
    ...
    html: "<p>Who's up for a weekend hike in the mountains? I've been craving some outdoor adventure, and a hike in the mountains sounds like the perfect escape. If you're up for the challenge, we can explore some scenic trails and enjoy the beauty of nature.</p><p>I've done some research and have a few routes in mind.</p><p>Let me know if you're interested, and we can plan the details.</p><p>It's sure to be a memorable experience! Samuel</p>",
...
export type MailItems = MailItem[]

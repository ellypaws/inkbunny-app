// Package table is provided by 76creates
//
// Use of this [source code] is governed by the [MIT license] that can be found in
// the [LICENSE] file.
//
// [source code]: https://github.com/76creates/stickers/blob/master/table/table.go
// [MIT license]: https://opensource.org/licenses/MIT
// [LICENSE]: https://github.com/76creates/stickers/blob/master/LICENSE
package table
...
func sortIndex[T Ordered](slice []T, order SortingOrderKey) []int {
	...
	var index = make([]int, len(slice), len(slice))
